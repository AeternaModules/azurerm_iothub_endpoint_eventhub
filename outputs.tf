output "iothub_endpoint_eventhubs_id" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.id if v.id != null && length(v.id) > 0 }
}
output "iothub_endpoint_eventhubs_authentication_type" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.authentication_type if v.authentication_type != null && length(v.authentication_type) > 0 }
}
output "iothub_endpoint_eventhubs_connection_string" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.connection_string if v.connection_string != null && length(v.connection_string) > 0 }
  sensitive   = true
}
output "iothub_endpoint_eventhubs_endpoint_uri" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.endpoint_uri if v.endpoint_uri != null && length(v.endpoint_uri) > 0 }
}
output "iothub_endpoint_eventhubs_entity_path" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.entity_path if v.entity_path != null && length(v.entity_path) > 0 }
}
output "iothub_endpoint_eventhubs_identity_id" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.identity_id if v.identity_id != null && length(v.identity_id) > 0 }
}
output "iothub_endpoint_eventhubs_iothub_id" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.iothub_id if v.iothub_id != null && length(v.iothub_id) > 0 }
}
output "iothub_endpoint_eventhubs_name" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.name if v.name != null && length(v.name) > 0 }
}
output "iothub_endpoint_eventhubs_resource_group_name" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "iothub_endpoint_eventhubs_subscription_id" {
  ...
  value       = { for k, v in azurerm_iothub_endpoint_eventhub.iothub_endpoint_eventhubs : k => v.subscription_id if v.subscription_id != null && length(v.subscription_id) > 0 }
}
